...
async function checkSplashScreenImages(projectRoot) {
  ...
  const generalSplashImage = await (0, _ImageUtils().getImageDimensionsAsync)(projectRoot, generalSplashImagePath);
  ...
  for (const {
    ...
    if (imageRelativePath) {
      const splashImage = await (0, _ImageUtils().getImageDimensionsAsync)(projectRoot, imageRelativePath);
