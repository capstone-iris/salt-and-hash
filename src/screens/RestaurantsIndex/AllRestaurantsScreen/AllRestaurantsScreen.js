			...
			<SafeAreaView style={styles.container}>
				{this.state.restaurantList.length === 0 ? (
					<View style={styles.buttonContainer}>
						<TouchableOpacity
							style={styles.button}
							onPress={() => this.handleRestaurantSearch()}
						>
						...
						<FlatList
							...
							renderItem={({ item }) => (
								...
								<View style={styles.indRestaurantContainer}>
									...
									<Text style={styles.indRestaurantHeader}>{item.name}</Text>

									<Text style={styles.indRestaurantTextBody}>
										<AntDesign name='star' size={16} color='#2a9d8f' />{' '}
										{item.rating} | {item.user_ratings_total} ratings
									</Text>

									<TouchableRipple onPress={() => {}}>
										<Text style={styles.indRestaurantTextBody}>
											<AntDesign name='heart' size={16} color='#2a9d8f' /> Add
											to Favorites
										</Text>
									</TouchableRipple>
