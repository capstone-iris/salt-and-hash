            ...
            <View style={styles.restaurantsContainer}>
              ...
              <TouchableOpacity
                onPress={() =>
                  Communications.text(
                    null,
                    `Hello, friend! I'd love to invite you to join me for an event! Download the Expo app, sign-up, RSVP, and vote for a restaurant! Here's a link to your invite: Here's a link to the app: https://expo.io/@weronikajanczuk/projects/eventplanningapp`
                  )
                }
              >
                <Text style={styles.restaurantsTextHeader}>
                  Invite Friends Over Text
                </Text>
              </TouchableOpacity>
            </View>
